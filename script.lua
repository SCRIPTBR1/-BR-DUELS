-- 🌹BR AUTO GRAB - Otimizado para Delta Executor
-- By: 32e4
...
local function updateTopBar()
    ...
    RunService.RenderStepped:Connect(function()
        ...
        infoLabel.Text = "🌹BR AUTO GRAB | Ping: " .. ping .. "ms | FPS: " .. fps
    end)
end
...
local function setupUI()
    local sg = lp.PlayerGui:FindFirstChild("Irish Hub")
    if not sg then
    ...
    if not progressBarBg then
        ...
        container.Position = UDim2.new(0.5, -130, 0, -10) -- MUDADO: Y = -10 (subiu mais)
        ...
        bannerFrame.BackgroundColor3 = Color3.fromRGB(255, 0, 0)
        ...
        bannerStroke.Color = Color3.fromRGB(255, 0, 0)
        ...
        infoLabel.Text = "🌹BR AUTO GRAB | Ping: 0ms | FPS: 0"
        infoLabel.TextXAlignment = Enum.TextXAlignment.Center
        infoLabel.Parent = bannerFrame

        progressBarBg = Instance.new("Frame")
        progressBarBg.Size = UDim2.new(1, 0, 0, 24)
        progressBarBg.Position = UDim2.new(0, 0, 0, 38)
        ...
        statusLabel.Parent = progressBarBg
...
local function updateUI()
    if not progressFill or not statusLabel or not bannerFrame or not bannerStroke then return end
    while true do
        local character = S.LocalPlayer.Character
...
-- Comandos para o Delta Executor
print("🌹BR AUTO GRAB - Carregado com sucesso!")
print("Comandos disponíveis:")
print("  _G.AUTO_STEAL = true/false - Ativar/Desativar auto steal")
print("  _G.CONFIG.HOLD_MIN = 1.3 - Tempo mínimo de hold")
print("  _G.CONFIG.HOLD_MAX = 2.6 - Tempo máximo de hold")

-- Expor configurações para o usuário
_G.AUTO_STEAL = true
_G.CONFIG = CONFIG
...
local function buildGui()    
    ...
    local C_RED       = Color3.fromRGB(200,20,20)    
    ...
    local C_ACCENT    = Color3.fromRGB(200,200,200)    
    local TOTAL_W = 480; local TOTAL_H = 680; local SIDEBAR_W = 175    
    
    pcall(function() local old = game:GetService("CoreGui"):FindFirstChild("BRDUELS"); if old then old:Destroy() end end)    
    pcall(function() local old = LP:WaitForChild("PlayerGui"):FindFirstChild("BRDUELS"); if old then old:Destroy() end end)    
    ...
    divider.BackgroundColor3 = Color3.fromRGB(200,20,20)    
    ...
    titleLabel.BackgroundTransparency = 1; titleLabel.Text = "🌹BR DUELS"    
    titleLabel.TextColor3 = Color3.fromRGB(255,60,60); titleLabel.Font = Enum.Font.GothamBlack    
    titleLabel.TextSize = 26; titleLabel.TextXAlignment = Enum.TextXAlignment.Center; titleLabel.ZIndex = 999    
    ...
    accentLine.BackgroundColor3 = Color3.fromRGB(200,20,20); accentLine.BackgroundTransparency = 0    
    ...
    for i, name in ipairs(TAB_NAMES) do    
        ...
        activeIndicator.BackgroundColor3 = Color3.fromRGB(200,20,20)    
    ...
    local function mkToggle(pg, label, defOn, onToggle)    
        ...
        pillBg.BackgroundColor3 = defOn and Color3.fromRGB(200,20,20) or Color3.fromRGB(40,40,40)    
        ...
        if cardStroke and defOn then    
            cardStroke.Color = Color3.fromRGB(200,20,20)    
            cardStroke.Thickness = 1.5    
        end    
        local isOn = defOn or false    
        local function setV(on)    
            isOn = on    
            pillBg.BackgroundColor3 = on and Color3.fromRGB(200,20,20) or Color3.fromRGB(40,40,40)    
            ...
            if cardStroke then    
                cardStroke.Color = on and Color3.fromRGB(200,20,20) or Color3.fromRGB(40,40,40)    
    ...
    local function buildSpeedTab()    
        ...
        local C_BORDER_ACTIVE   = Color3.fromRGB(200,20,20)    
        local C_WHITE = Color3.fromRGB(255,255,255)    
    ...
    local function buildMainTab()
        ...
        do
            ...
            local function setJumpVisual(on)
                ...
                if jumpCardStroke then
                    jumpCardStroke.Color = on and Color3.fromRGB(200,20,20) or Color3.fromRGB(40,40,40)
        ...
        do
            ...
            local modeLabel = Instance.new("TextButton", card)
            modeLabel.Size = UDim2.new(0,60,0,24); modeLabel.Position = UDim2.new(0.5,-30,0.5,-12)
            modeLabel.BackgroundColor3 = Color3.fromRGB(200,20,20); modeLabel.BorderSizePixel = 0
            modeLabel.Text = "V1"; modeLabel.TextColor3 = Color3.fromRGB(255,255,255)
            modeLabel.Font = Enum.Font.GothamBold; modeLabel.TextSize = 10; modeLabel.ZIndex = 999
            Instance.new("UICorner", modeLabel).CornerRadius = UDim.new(0,6)

            local pillBg = Instance.new("Frame", card)
            pillBg.Size = UDim2.new(0,28,0,16); pillBg.Position = UDim2.new(1,-36,0.5,-8)
            pillBg.BackgroundColor3 = Color3.fromRGB(200,20,20); pillBg.BorderSizePixel = 0; pillBg.ZIndex = 999
            Instance.new("UICorner", pillBg).CornerRadius = UDim.new(1,0)
            local dot = Instance.new("Frame", pillBg)
            dot.Size = UDim2.new(0,12,0,12); dot.Position = UDim2.new(0,2,0.5,-6)
            ...
            modeLabel.MouseButton1Click:Connect(function()
                ...
                modeLabel.BackgroundColor3 = isV2 and Color3.fromRGB(200,20,20) or Color3.fromRGB(255,255,255)
                modeLabel.TextColor3 = isV2 and Color3.fromRGB(255,255,255) or Color3.fromRGB(0,0,0)
                modeLabel.Text = isV2 and "V2" or "V1"
                pillBg.BackgroundColor3 = isV2 and Color3.fromRGB(200,20,20) or Color3.fromRGB(255,255,255)
                dot.BackgroundColor3 = Color3.fromRGB(15,8,30)
            end)

            local initIsV2 = S.dropBrainrotVersion == 2
            modeLabel.BackgroundColor3 = initIsV2 and Color3.fromRGB(200,20,20) or Color3.fromRGB(255,255,255)
            modeLabel.TextColor3 = initIsV2 and Color3.fromRGB(255,255,255) or Color3.fromRGB(0,0,0)
            modeLabel.Text = initIsV2 and "V2" or "V1"
            pillBg.BackgroundColor3 = initIsV2 and Color3.fromRGB(200,20,20) or Color3.fromRGB(255,255,255)
    ...
    local function buildMoveTab()    
        ...
        do
            ...
            clickArea.MouseButton1Click:Connect(function()
                isOn = not isOn
                pillBg.BackgroundColor3 = isOn and Color3.fromRGB(200,20,20) or Color3.fromRGB(40,40,40)
        ...
        do    
            ...
            local function setStealVis(on)    
                stealOn = on    
                pill.BackgroundColor3 = on and Color3.fromRGB(200,20,20) or Color3.fromRGB(40,40,40)    
                dot.Position = on and UDim2.new(1,-14,0.5,-6) or UDim2.new(0,2,0.5,-6)    
        ...
        do    
            ...
            resetStroke.Color = Color3.fromRGB(200,20,20)
    ...
    local function buildGui_createMiniToggle(guiParent, showFn)    
        ...
        miniMainText.Text = "🌹BR DUELS"    
        miniMainText.TextColor3 = Color3.fromRGB(200,20,20)    
        miniMainText.Font = Enum.Font.GothamBlack    
        miniMainText.TextSize = 13    
...
local function createFloatingButtonPanel()    
    ...
    local WHITE_ON  = Color3.fromRGB(200,20,20)    
    local STROKE_OFF = Color3.fromRGB(100,100,100)    
    local STROKE_ON  = Color3.fromRGB(200,20,20)    
    ...
    local function makePButton(label1, label2, order)    
        ...
        glowStroke.Color = Color3.fromRGB(200,20,20)    
    ...
    local function setButtonActive(btn, stroke, label1, label2, active)    
        btn.BackgroundColor3 = active and Color3.fromRGB(200,20,20) or BLACK_OFF    
        stroke.Color = active and Color3.fromRGB(255,60,60) or STROKE_OFF    
...
local function createSpeedPanel()    
    ...
    local function makeIndependentSpeedButton(presetNum, defaultOffsetX, defaultOffsetY)    
        ...
        g.Name = "BRDUELS_SpeedPanel" .. presetNum    
        ...
        btn.TextColor3 = Color3.fromRGB(200,20,20); btn.Font = Enum.Font.GothamBlack    
        ...
        local function updateVisual()    
            ...
            btn.BackgroundColor3 = isActive and Color3.fromRGB(200,20,20) or Color3.fromRGB(0,0,0)    
            btn.TextColor3 = isActive and Color3.fromRGB(255,255,255) or Color3.fromRGB(200,20,20)    
            stroke.Color = isActive and Color3.fromRGB(200,20,20) or Color3.fromRGB(100,100,100)    
...
local function createHUD()
    ...
    local BRIGHT_RED = Color3.fromRGB(255,60,60)
    ...
    pbs.Color = RED; pbs.Thickness = 1.5; pbs.Transparency = 0.1
    local pbsGrad = Instance.new("UIGradient", pbs)
    pbsGrad.Color = ColorSequence.new(RED, BRIGHT_RED)
    pbsGrad.Rotation = 25
    ...
    pingLbl.Text = "PING:--"
    pingLbl.TextColor3 = Color3.fromRGB(180,180,180)
    ...
    radStroke.Color = RED; radStroke.Thickness = 1; radStroke.Transparency = 0.35
    local radStrokeGrad = Instance.new("UIGradient", radStroke)
    radStrokeGrad.Color = ColorSequence.new(RED, BRIGHT_RED)
    ...
    S.progressFill.BackgroundColor3 = RED
    ...
    fillGrad.Color = ColorSequence.new(RED, BRIGHT_RED)
...
local function createInstaResetFloatingButton()
    ...
    local function setActive(state)
        if state then
            btnFrame.BackgroundColor3 = Color3.fromRGB(200,20,20)
...
print("[🌹BR DUELS] Carregado com sucesso. Aimbot de bat pronto.")
